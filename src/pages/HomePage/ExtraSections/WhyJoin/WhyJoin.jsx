...
const WhyJoin = () => (
    <section className="md:w-10/12 w-11/12 mx-auto py-6 mt-20">
        <h2 className="text-3xl font-bold text-center mb-8 text-gray-900">
            Why Join Our Study Sessions?
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
            <div className="bg-base-200 p-6 rounded-lg shadow hover:shadow-lg transition flex flex-col items-center gap-4">
